...
$(document).ready(function () {
  $('[data-show="catalog"').on('click', function () {
    ...
    $('.catalog__title_close').css('display', 'block'); // $('.catalog-list').css('display', 'flex')
  });
  $('[data-hide="catalog"').on('click', function () {
    $('.catalog__title_open').css('display', 'block');
    $('.catalog__title_close').css('display', 'none'); // $('.catalog-list').css('display', 'none')
  });
  ...
  $(window).scroll(function () {
    ...
    var w = $(window).width(); // let h = $(window).height();
